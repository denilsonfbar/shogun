...
#pragma omp parallel shared(begin,landmarks,distance_matrix,callback,n_landmarks) 
	{
...
#pragma omp parallel shared(begin,end,to_process,distance_callback,landmarks, \
		landmarks_embedding,landmark_distances_squared,embedding,n_landmarks,n_vectors) 
	{
...
#pragma omp parallel shared(begin,distance_matrix,callback,n_vectors) 
	{
		IndexType i_index_iter,j_index_iter;
#pragma omp for nowait
